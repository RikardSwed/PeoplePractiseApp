import { store } from "./storage.js?v=0.9.0";
import { initFileTest } from "./file-test.js?v=0.9.0";
import { initVersionInfo } from "./version.js?v=0.9.0";
...
const formatted=prettyDate(todayKey);$("#today-date").textContent=formatted.charAt(0).toUpperCase()+formatted.slice(1);store.subscribe(renderAll);window.addEventListener("hashchange",showView);initFileTest();initVersionInfo();showView();renderAll();
